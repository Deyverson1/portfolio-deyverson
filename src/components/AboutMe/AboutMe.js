    ...
    <AboutMeContainer>
      ...
      <SectionContainer>
        ...
        <div className="descriptionMobile">
          ...
          <p>
            Mi enfoque principal se encuentra en la creacion de experiencias de
            usuario atractivas y eficientes.
            <br />
            Mi objetivo es ampliar mi conjunto de habilidades para barcar el
            desarrollo backend y poder crear poyectos web completos.
            <br />
            Siempre estoy en búsqueda de nuevos desafíos y oportunidades para
            crecer como desarrollador. Me emociona el proceso de aprendizaje
            constante y estoy ansioso por contribuir al mundo digital con

    ...
    <section className="flex bg-black py-20 px-20 flex-wrap lg:flex-nowrap">
      ...
      <section className="pt-8 lg:pt-0 flex flex-col items-center justify-center w-full">
        ...
        <div className="flex gap-x-4 pt-4">
          {dataIconsFooter.map((icon, index) => (
            <a key={index} href={icon.href} target="blank">
              {icon.svg}
            </a>
          ))}
        </div>
